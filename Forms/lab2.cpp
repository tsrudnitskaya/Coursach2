#include "lab2.h"
#include "../Lab2/lab2_2_func.h"

using namespace System;
using namespace System::Windows::Forms;

static std::string filename = "";
System::Void Coursach2::lab2::button1_Click(System::Object^ sender, System::EventArgs^ e)
{
	this->Close();
}

System::Void Coursach2::lab2::cbBegin_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e)
{
...
void Coursach2::lab2::showErr(String^ text)
{
	MessageBox::Show(text, "ќшибка!");
}


System::Void Coursach2::lab2::formBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	int num, err = 0;
	labTimer t;
	switch (cbBegin->SelectedIndex) {
...
listItem* Coursach2::lab2::generateList(int listWidth)
{
	listItem* Curr = 0,
		* Next = 0;
...
int Coursach2::lab2::parceStringToArray(std::string s, int num, int* arr)
{
	std::string temp = s;
	int el;
	for (int i = 0; i < num; ++i) {
...
listItem* Coursach2::lab2::parceStringToList(std::string s, int num)
{
	std::string temp = s;
	int el;
	listItem* Curr = 0,
...
void Coursach2::lab2::generateArray(int num, int* Arr)
{
	generateArrayElements(num, min, max, Arr);
}

listItem* Coursach2::lab2::foundForIdInList(int id)
{
	listItem* Curr = list;
	int i = 0;
	while (Curr) {
...
listItem* Coursach2::lab2::foundForValuerInList(int num, int& id)
{
	listItem* Curr = list;
...
System::Void Coursach2::lab2::addBtn_Click_1(System::Object^ sender, System::EventArgs^ e)
{
	int num;
...
void Coursach2::lab2::addToArray(int num, int*& arr)
{
	if (N) {
		N += 1;
		int* temp = new int[N];
...
void Coursach2::lab2::addToList(int num)
{
...
void Coursach2::lab2::deleteFromList(listItem* del)
{
...
void Coursach2::lab2::deleteForIdFromList(int num)
{
...
System::Void Coursach2::lab2::deleteId_Click(System::Object^ sender, System::EventArgs^ e)
{
	int num;
	if (!getIntFromString(numTb->Text, num))
		numTb->BackColor = Color::LightPink;
...
void Coursach2::lab2::deleteForId(int num, int*& arr)
{
...
System::Void Coursach2::lab2::deleteValue_Click(System::Object^ sender, System::EventArgs^ e)
{
	int num;
	if (!getIntFromString(numTb->Text, num))
		numTb->BackColor = Color::LightPink;
...
void Coursach2::lab2::deleteForValue(int num, int*& arr)
{
...
void Coursach2::lab2::deleteForValueFromList(int num)
{
	int id;
...
System::Void Coursach2::lab2::foundId_Click(System::Object^ sender, System::EventArgs^ e)
{
	int num;
	if (!getIntFromString(numTb->Text, num))
		numTb->BackColor = Color::LightPink;
...
int Coursach2::lab2::isIdInList(int num)
{
	if (listN == 0) {
...
int Coursach2::lab2::isIdInArray(int num)
{
	if (N == 0) {
...
void Coursach2::lab2::foundForId(int num, int*& arr)
{
	if (num <= N && num >= 0) {
...
System::Void Coursach2::lab2::foundValue_Click(System::Object^ sender, System::EventArgs^ e)
{
	int num;
	if (!getIntFromString(numTb->Text, num))
		numTb->BackColor = Color::LightPink;
...
System::Void Coursach2::lab2::browseBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
int Coursach2::lab2::foundForValue(int num, int*& arr)
{
	int id = -1;
	for (int i = 0; i < N; ++i) {
		if (arr[i] == num) {
...
String^ Coursach2::lab2::formListOut(listItem* begin)
{
	String^ text = "";
	listItem* Curr = begin;
	while (Curr) {
