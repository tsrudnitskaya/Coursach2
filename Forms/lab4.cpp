...
System::Void Coursach2::lab4::btnCloseForm_Click(System::Object^ sender, System::EventArgs^ e)
{
	this->Close();
}
...
System::Void Coursach2::lab4::browseBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	filename = browseFile(openFileDialog1);
}


void Coursach2::lab4::showEmptyTable(int m)
{
	for (int i = 0; i < m; i++) {
...
int Coursach2::lab4::getDataFromFile()
{
...
void Coursach2::lab4::pushDataToG(std::vector <std::vector <int> >& arr)
{
	std::string temp = "";
...
System::Void Coursach2::lab4::addGraphFromFile_Click(System::Object^ sender, System::EventArgs^ e)
{
	consoleBox->Text = "";
	getDataFromFile();
	edges.clear();
...
System::Void Coursach2::lab4::addGraphFromTable_Click(System::Object^ sender, System::EventArgs^ e)
{
	consoleBox->Text = "";
	edges.clear();
	edges.shrink_to_fit();
...
System::Void Coursach2::lab4::initBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Coursach2::lab4::findMstBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
void Coursach2::lab4::findMst(std::vector<std::vector<int>>& g, std::vector<std::vector<int>>& m, int nodes, bool& isConnected)
{
...
System::Void Coursach2::lab4::generateBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	std::string temp = "";
	bool isConnected;
	bigData.clear();
...
System::Void Coursach2::lab4::sort_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (bigData.size() != 0) {
		labTimer t;
...
void Coursach2::lab4::insertSort(std::vector<std::vector<int>>& g)
{
