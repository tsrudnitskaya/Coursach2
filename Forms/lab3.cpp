...
System::Void Coursach2::lab3::btnCloseForm_Click(System::Object^ sender, System::EventArgs^ e)
{
    this->Close();
}
std::string Coursach2::lab3::getString()
{
	std::string s = "";
	if (keyRadio->Checked) {
...
void Coursach2::lab3::showArr(std::vector<std::string>& arr, String^& consoleText)
{
	String^ s;
	for (auto& el : arr) {
...
bool Coursach2::lab3::isExValid(std::string s, std::vector<std::string>& arr, String^& consoleText)
{
	int bracket = 0;
...
bool Coursach2::lab3::isPnValid(std::string s, std::vector<std::string>& arr, String^& consoleText)
{
	String^ S;
	consoleText = "";
...
bool Coursach2::lab3::isRpnValid(std::string s, std::vector<std::string>& arr, String^& consoleText)
{
	String^ S;
	consoleText = "";
...
std::vector<std::string> Coursach2::lab3::convertToPn(std::vector<std::string>& arr, String^& consoleText)
{
...
std::vector <std::string> Coursach2::lab3::convertToRpn(std::vector<std::string>& arr, String^& consoleText)
{
...
bool Coursach2::lab3::calcEx(std::vector<std::string>& input, String^& consoleText, double& num)
{
...
bool Coursach2::lab3::calcRpn(std::vector<std::string>& input, String^& consoleText, double& num)
{
	std::string el = "";
	String^ temp;
...
void Coursach2::lab3::recursiveCalc(std::vector<std::string>& stack, String^& consoleText, bool& err)
{
	String^ temp;
	double res, op1, op2;
...
bool Coursach2::lab3::calcPn(std::vector<std::string>& input, String^& consoleText, double& num)
{
	std::string el = "";
	String^ temp;
	std::vector<std::string> stack;
...
bool Coursach2::lab3::substToEx(std::vector<std::string>& arr, String^& consoleText)
{
	String^ temp = "";
...
System::Void Coursach2::lab3::browseBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Coursach2::lab3::exCheckBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	bool isValid;
...
System::Void Coursach2::lab3::exConvertBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	bool flag;
	std::string s = getString();
	String^ consoleText = "";
...
System::Void Coursach2::lab3::exCalcBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	bool flag;
	std::string s = getString();
	consoleBox->Text = "";
