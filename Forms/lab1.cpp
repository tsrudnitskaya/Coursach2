...
System::Void Coursach2::lab1::btnCloseForm_Click(System::Object^ sender, System::EventArgs^ e)
{
	this->Close();
}
int Coursach2::lab1::checkFileErr1(int numOfLines, int numFields)
{
...
System::Void Coursach2::lab1::browseBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	openFileDialog1->InitialDirectory = Application::StartupPath;
	openFileDialog1->Filter = "txt files (*.txt)|*.txt";
	openFileDialog1->ShowDialog();
	convert_String_to_string(openFileDialog1->FileName, filename);
	fileReadingBtn->Visible = true;
}

System::Void Coursach2::lab1::fileReadingBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
void Coursach2::lab1::reloadForm(std::vector<Student>(&arr)) {
...
void Coursach2::lab1::saveFile(std::string filename, std::vector<Student>(&db))
{
...
int Coursach2::lab1::getInputNumberData(TextBox^ tb)
{
	std::string s;
...
void Coursach2::lab1::loadDataWithId(int id)
{
...
bool Coursach2::lab1::getDataFromForm(Student& temp)
{
	short err = 0;
	std::string tempstr = "";
...
double Coursach2::lab1::averageScore(short* arr)
{
...
void Coursach2::lab1::insertSortAS(int arrayWidth, std::vector<Student>(&arr))
{
...
bool Coursach2::lab1::isFellow(short* arr, short edForm)
{
...
bool Coursach2::lab1::minMarks(short* arr, short min)
{
	for (int i = 0; i < marksNum; ++i)
...
bool Coursach2::lab1::isOneDate(DateTime start, DateTime end, String^ d)
{
...
bool Coursach2::lab1::isOneTime(DateTime^ timeStart, DateTime^ timeEnd, String^ d)
{
	DateTime recordDate = convertDate(d);
...
void Coursach2::lab1::getData(std::string filename, std::vector<Student>(&db))
{
	if (checkFile(filename)) {
		db.clear();
		Student buf;
...
void Coursach2::lab1::showHeader()
{
...
void Coursach2::lab1::showData(std::vector<Student>(&arr))
{
	std::string temp;
...
System::Void Coursach2::lab1::addBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	Student temp;
...
System::Void Coursach2::lab1::btnSaveFile_Click(System::Object^ sender, System::EventArgs^ e)
{
	saveFile(filename, db);
}

System::Void Coursach2::lab1::editBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Coursach2::lab1::saveBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	Student temp;
	bool checkForm = getDataFromForm(temp);
...
System::Void Coursach2::lab1::genderBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	int femNum = 0;
...
System::Void Coursach2::lab1::groupBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Coursach2::lab1::topBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Coursach2::lab1::reloadBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	reloadForm(db);
}

System::Void Coursach2::lab1::fellowshipBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	int fellowNum = 0;
	for (auto& record : db) {
...
System::Void Coursach2::lab1::marksFilterBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	std::vector<Student> temp;
...
System::Void Coursach2::lab1::dateBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	std::vector<Student> temp;
	for (auto& record : db) {
...
System::Void Coursach2::lab1::timeFilterBtn_Click(System::Object^ sender, System::EventArgs^ e)
{
	std::vector<Student> temp;
	DateTime^ timeStart;
	DateTime^ timeEnd;
